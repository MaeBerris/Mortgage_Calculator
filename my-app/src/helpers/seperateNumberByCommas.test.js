...
describe("seperateNumberByComma", () => {
  ...
  test("given a string where the quantity of numbers is divisible by three, it should return that string without the starting comma", () => {
  ...
  test("given a string of a decimal number, it should seperate the number by commas before the decimal and not after", () => {
